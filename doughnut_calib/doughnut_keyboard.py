...
## Code fetched from https://github.com/RoverRobotics-archive/ros2-keyboard-driver/blob/master/launch/listen.launch.py
...
class KeystrokeListen:
    def __init__(self, name=None):
        self.node = rclpy.create_node('doughnut_keyboard_node')
    ...
    def exit_on_esc(self):
        ...
        #
        # if param.type_ != Parameter.Type.BOOL:dddd
